...
/**
 * Окно статистики сахара в крови
 */
...
public class BloodSugarActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Blood_main_fragment(),  getResources().getString(R.string.weight_main_tab_text));
        adapter.addFragment(new Blood_statistics_fragment(),  getResources().getString(R.string.weight_statistics_tab_text));
