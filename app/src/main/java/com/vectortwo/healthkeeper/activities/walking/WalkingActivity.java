...
/**
 * Окно отображает активность (ходьба)
 */
...
public class WalkingActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Walking_main_fragment(),  getResources().getString(R.string.weight_main_tab_text));
        adapter.addFragment(new Walking_statistics_fragment(),  getResources().getString(R.string.weight_statistics_tab_text));
