...
public class SleepActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Sleep_main_fragment(),  getResources().getString(R.string.weight_main_tab_text));
        adapter.addFragment(new Sleep_statistics_fragment(),  getResources().getString(R.string.weight_statistics_tab_text));
