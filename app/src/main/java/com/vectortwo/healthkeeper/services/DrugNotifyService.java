...
public class DrugNotifyService extends IntentService {
    ...
    private void scheduleNotification(int drugID) {
        ...
        Calendar scheduleDate = getScheduleDate(currentDate, startDate, endDate, weekdays, times);
    ...
    @Nullable
    public static Calendar getScheduleDate(Calendar currentDate, Calendar startDate, Calendar endDate,
                                     ArrayList<Integer> weekdays, /*sorted*/ ArrayList<String> times) {
        // startDate is in the past
        if (currentDate.compareTo(startDate) > 0)
            return getScheduleDate(currentDate, currentDate, endDate, weekdays, times);
